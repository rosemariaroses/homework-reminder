/*
    Dark Mode extension for homework by luphoria.
...
Page.register({
  ...
  Info: "Dark Mode extension for homework by luphoria.",
  Description:
    "This extension can toggle a dark mode on pages viewed via homework.",
  page: "DarkMode",
  name: "DarkMode",
});
